...
latex_documents = [
    (master_doc, 'ottemplatepythondoc.tex', u'ottemplatepython Documentation',
     u'First Name', 'manual'),
]
...
man_pages = [
    (master_doc, 'ottemplatepythondoc', u'ottemplatepython Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ottemplatepythondoc', u'ottemplatepython Documentation',
     author, 'ottemplatepython', 'One line description of project.',
     'Miscellaneous'),
]
